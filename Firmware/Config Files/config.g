...
M566 X600 Y600 Z24 E150			; Set the jerk limits, mm/min
M906 X800 Y800 Z800 E500 I30	; Set motor currents(mA) and motor idle factor in %
...
M591 D0 P5 C3 R10:100 E3.0 S1  	; Duet3D laser sensor for extruder drive 0, connected to endstop input 3 (E0), tolerance 30 to 80%, 3mm comparison length, enabled
...
G31 P25 X28 Y3 Z0.20				; Set Z probe trigger value, offset and trigger height 
...
M307 H1 A692.8 C253.1 D5.5 S1.00 V24.3 B0
M305 P1 T100000 B4725 C7.060000e-8 R4700		; Set thermistor + ADC parameters for heater 1
M143 H1 S285									; Set temperature limit for heater 1 to 285C

; Fans
M106 P0 S0 I0 B1 F200 H-1 C"Cooling fan"		; Set fan 0 value, PWM signal inversion and frequency. Thermostatic control is turned off
M106 P1 S1 I0 B1 F500 H1 T50 C"Hotend fan"		; Set fan 1 value, PWM signal inversion and frequency. Thermostatic control is turned on
M106 P2 S1 I0 B1 F500 H1 T50 C"Controller fan"	; Set fan 2 value, PWM signal inversion and frequency. Thermostatic control is turned on
